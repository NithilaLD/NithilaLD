...
|---|---|---|---|---|
| ThreatSense - IoT Intrusion Detection System (IDS) https://github.com/Dersett/Small_ITBusiness | ThreatSense IoT is a lightweight distributed Intrusion Detection System that secures resource-constrained IoT environments through multi-layered edge filtering and centralized threat analytics.<br>Main Deliverables:<br><ul><li>Project Proposal<br>https://github.com/Dersett/Threat-Sense-IOT/blob/main/Project%20Proposal.pdf</li><li>Project Poster<br>https://github.com/Dersett/Threat-Sense-IOT/blob/main/Project%20Poster.pdf</li><li>Project Completion Report<br>https://github.com/Dersett/Threat-Sense-IOT/blob/main/Project%20Completion%20Report.pdf</li><li>User Manual<br>https://github.com/Dersett/Threat-Sense-IOT/blob/main/User%20Manual.pdf</li></ul> | `Fast API`, `React`, `TypeScript`, `Tailwind CSS`, `Recharts`, `Scikit-learn`, `Pandas`, `NumPy`, `Joblib`, `PostgreSQL` | `Visual Studio Code`, `Github`, `Suricata`, `Wire Guard VPN`, `Docker`, `NGINX` | Group |
| Diabetes Data Analysis & Prediction https://www.kaggle.com/code/dulannliyanarachchi/diabetes-prediction-and-exploratory-data-analysis | An individual Business Analytics project did for the Year 2 Business Analysis Module which focused on using data to understand diabetes risk factors and evaluate how predictive analytics could support better decision-making.<br><ul><li>Project Report<br>https://github.com/NithilaLD/Diabetes-Data-Study/blob/main/Report.pdf</li><li>Github Repository<br>https://github.com/NithilaLD/Diabetes-Data-Study/blob/main/Report.pdf</li></ul> | `Python`, `Pandas`, `NumPy`, `Matplotlib`, `Seaborn`, `Scikit-learn` | `Visual Studio Code`, `Github`, `Jupyter Notebook`, `Kaggle` | Individual |
| Official Website of Mathematics and Statistics Circle NSBM | Led the design, development, and deployment of the official Mathematics and Statistics Circle website, creating a centralized, responsive platform to showcase events, news, and academic activities using HTML, CSS, JavaScript, PHP, and MySQL. https://mathscircle.nsbm.ac.lk/|  `HTML`, `Javascript(js)`, `CSS`, `PHP`, `MySQL` | `XAMPP`, `PHPMyAdmin`, `Visual Studio Code`, `Github` | Group |
...
| ThreatSense - IoT Intrusion Detection System (IDS) Business Proposal https://github.com/Dersett/Small_ITBusiness | For our NIT3274 - Small IT Business final project, our team created a startup called ThreatSense, which offers a next-generation Intrusion Detection System (IDS) for IoT devices.<br>The project included three main deliverables:<br><ul><li>Business Proposal https://dersett.github.io/Small_ITBusiness/Business%20Proposal.pdf</li><li>Responsive Marketing Website https://dersett.github.io/Small_ITBusiness/</li><li>Mobile Application https://median.co/share/epdkqk |  `HTML`, `Javascript(js)`, `CSS`, `Android(Java/Kotlin)`  | `Visual Studio Code`, `Github`, `Github Pages` | Group |
| MathMaster - Inter School Mathematics Competition Platform System https://github.com/NithilaLD/NSBM-MathMaster | Developed a comprehensive Privacy Impact Assessment (PIA) and Privacy Policy for a proposed Secure Electronic Fine Management System (SEF) designed to modernize electronic fine issuance and improve transparency in law enforcement processes. | `ReactJS`, `Typescript`, `Vite`, `ExpressJS`, `PostGreSQL`| `Replit`, `Github` | Duo |
| Secure E-Fines (SEF) - Privacy Risk Assessment https://github.com/NithilaLD/Secure-E-Fines-Privacy-Risk-Assessment | The system hosts the MathMaster inter-school mathematics competition.<br>Main Deliverables:<br><ul><li>Privacy Impact Assessment<br>https://github.com/NithilaLD/Secure-E-Fines-Privacy-Risk-Assessment/blob/main/Privacy%20Impact%20Assessment.pdf</li><li>Privacy Policy<br>https://github.com/NithilaLD/Secure-E-Fines-Privacy-Risk-Assessment/blob/main/Privacy%20Policy.pdf</li></ul> | `Cyber Security`, `Data Privacy & Security`, `Design` | `Canva`, `Github` | Triad |
...
| Resto Point Of Sale System https://github.com/NithilaLD/Resto_POS | A customizable POS system that streamlines restaurant operations and boosts efficiency and customer satisfaction | `Reactjs`, `Nodejs`, `PostgreSQL`, `Tailwind CSS` | `PGAdmin`, `Github`, `Jira`| Triad |
...
| O Seven Mobile Website https://github.com/NithilaLD/O-Seven-Mobile | Website for O Seven Mobile Shop<br>https://nithilald.github.io/O-Seven-Mobile/ | `HTML`, `Javascript(js)`, `CSS` | `XAMPP`, `PHPMyAdmin`, `Visual Studio Code`, `Github` | Individual |
