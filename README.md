...
<!-- <div style="max-width:100%; overflow-x:auto;"> -->
  ...
  |----------|----------|------------|----------|----------|
  | Hello Bags - Eco-friendly Packaging<br>(Bags and Boxes) Website | Developed a responsive, client-focused<br> website for hello bags lk,<br>highlighting sustainable packaging products<br> and enabling custom orders<br>for retail and bulk customers. |  `HTML`, `Javascript(js)`, `CSS`, `PHP`, `MySQL` | `XAMPP`, `PHPMyAdmin`, `Visual Studio Code`, `Github`, `Canva` | Individual |
