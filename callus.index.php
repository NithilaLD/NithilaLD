...
<head>
  ...
  <title>Call Us-Royal Cafe</title>
...
<body id="top">
  ...
  <main>
    <article>
      ...
      <section class="hero-callus" id="home">
        <div class="container">

          <h4 class="h4 hero-title">Wanna Contact Us</h4>
          <h1 class="h1 hero-title">Contact Now!</h1>
          ...
          <div class="btn-group">
            <button class="btn btn-primary"onclick="window.location.href='about.html.php'">Learn more</button>
 ...
 <section class="package" id="package">
  <div class="container">
    ...
    <p class="section-text">
      "Connect with us for a memorable cafe experience!
       Reach out now to reserve your table and inquire about our delicious offerings.
    ...
    <ul class="package-list">
      ...
      <li>
        <div class="package-card">
          ...
          <figure class="card-banner">
            <img src="./assets/images/other/call.jpg" alt="mobile" loading="lazy">
          </figure>

          <div class="card-content">

            <h3 class="h3 card-title">Contact Through Mobile Number</h3>

            <p class="card-text">
              "For instant inquiries and reservations, call us at any time. 
              Our team is ready to assist you in creating delightful moments at our cafe. Call now!"
            </p>
          ...
          <div class="card-price">
            ...
            <button class="btn btn-secondary" onclick="window.location.href='tel:+94778766809'">Contact Now</button>
      ...
      <li>
        <div class="package-card">
          ...
          <figure class="card-banner">
            <img src="./assets/images/other/whatsapp.jpg" alt="Timeless Italian Pasta Recipes Await" loading="lazy">
          </figure>

          <div class="card-content">

            <h3 class="h3 card-title">Contact Through Whatsapp</h3>

            <p class="card-text">
              "Chat with us on WhatsApp at any time for quick and convenient inquiries or reservations.
               We look forward to bringing joy to your cafe experience!"            </p>
          ...
          <div class="card-price">
            ...
            <p >
              +94 (77) 876 6809
              <span class="price">Whatsapp</span>
            </p>

            <button class="btn btn-secondary" onclick="window.location.href='https://wa.me/94778766809'">Contact Now</button>
      ...
      <li>
        <div class="package-card">
          ...
          <figure class="card-banner">
            <img src="./assets/images/other/facebook.jpg" alt="Comforting soups to warm youh" loading="lazy">
          </figure>

          <div class="card-content">

            <h3 class="h3 card-title">Contact Through Facebook</h3>

            <p class="card-text">
              "Stay connected on Facebook for the latest updates and to reach out for inquiries.
               Follow us now for a flavorful journey at our cafe!"
            </p>
          ...
          <div class="card-price">
            ...
            <p >
              Facebook/Royalcafe
              <span class="price">Facebook</span>
            </p>

            <button class="btn btn-secondary" onclick="window.location.href='https://www.facebook.com/Royalcafesrilanka'">Contact Now</button>
      ...
      <li>
        <div class="package-card">
          ...
          <figure class="card-banner">
            <img src="./assets/images/other/instagram.jpg" alt="instagram" loading="lazy">
          </figure>

          <div class="card-content">

            <h3 class="h3 card-title">Contact Through Instagram</h3>

            <p class="card-text">
              "Connect with us on Instagram for the latest cafe highlights and inquiries.
               Follow us now for a visual feast of our delectable offerings and updates."
            </p>
          ...
          <div class="card-price">
            ...
            <p >
              Instagram/Royalcafe
              <span class="price">Instagram</span>
            </p>
      ...
      <li>
        <div class="package-card">
          ...
          <figure class="card-banner">
            <img src="./assets/images/other/email.jpg" alt="email" loading="lazy">
          </figure>

          <div class="card-content">

            <h3 class="h3 card-title">Contact Through Mail</h3>

            <p class="card-text">
              "Have questions or want to order? Drop us an email at 
              any time. We're here to assist you in creating memorable moments at our cafe."
            </p>
          ...
          <div class="card-price">
            ...
            <p >
              amithkanchana@gmail.com 
              <span class="price">Email</span>
            </p>

            <button class="btn btn-secondary" onclick="window.location.href='mailto:amithkanchana@gmail.com'">Contact Now</button>
    ...
    <button class="btn btn-primary" onclick="window.location.href='callus.index.php'">Contact Now</button>
